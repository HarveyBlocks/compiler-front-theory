...
public class ProgramLexicalDemo {
    ...
    private static final List<LexicalPattern> REGEX_PATTERNS = List.of(
            ...
            new LexicalPattern("!=", ProgramTokenType.OPERATOR_NOT_EQUAL),
            new LexicalPattern("<=", ProgramTokenType.OPERATOR_LESS_EQUAL),
            new LexicalPattern(">=", ProgramTokenType.OPERATOR_GREATER_EQUAL),
            new LexicalPattern("+", ProgramTokenType.OPERATOR_PLUS),
            new LexicalPattern("-", ProgramTokenType.OPERATOR_MINUS),
            new LexicalPattern("\\*", ProgramTokenType.OPERATOR_MULTIPLY),
            new LexicalPattern("/", ProgramTokenType.OPERATOR_DIVIDE),
            new LexicalPattern("!", ProgramTokenType.OPERATOR_LOGICAL_NOT),
            new LexicalPattern("<", ProgramTokenType.OPERATOR_LESS),
            new LexicalPattern(">", ProgramTokenType.OPERATOR_GREATER),
