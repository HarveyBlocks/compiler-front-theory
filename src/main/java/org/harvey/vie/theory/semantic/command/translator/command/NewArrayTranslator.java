...
public class NewArrayTranslator implements CommandTranslator {
    ...
    public CommandNodeRegister translate(
        ...
        SourceToken token = TypeAttributes.childAnchor(context, 1);
        builder.add(new TerminalNode(context.getCommandFactory().newArray(token, type, summary.getTotalDimensions())));
