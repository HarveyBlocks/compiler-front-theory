...
public class ArrayTypeTranslator implements CommandTranslator {
    ...
    public CommandNodeRegister translate(
        ...
        if (baseType.isUnknown()) {
            return new PlaceholderNodeRegister(children[0].getType(), children[0].getInstructionType(), children[0].getAnchorToken());
        }
        ...
        return new PlaceholderNodeRegister(arrayType, arrayType, children[0].getAnchorToken());
    }
}
