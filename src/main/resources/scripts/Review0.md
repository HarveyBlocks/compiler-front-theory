...
- [ ] 将日志有关文件写入gitignore, 然后不要把日志上传到github  (简单)
- [ ] Boolean.getBoolean
  - 应当被统一管理, 而不是分散在各个地方
...
- [ ] Identifier#generate 的对数组的拷贝的问题
...
- [ ] DefineSimpleGrammarProduction中对tags的错误理解
